...
router.post("/upload", upload.single("image"), function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, contestId, userId, stream;
    return __generator(this, function (_b) {
        _a = req.body, contestId = _a.contestId, userId = _a.userId;
        if (!req.file || !contestId || !userId) {
            res.status(400).json({ message: "Missing data" });
            return [2 /*return*/];
        }
        try {
            stream = cloudinary_1.v2.uploader.upload_stream({
                folder: "ppp_screenshots/".concat(contestId, "/").concat(userId),
